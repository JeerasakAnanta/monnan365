const HIGHLIGHTS = [
  {
    ...
    desc: "ดอยภูคา ทะเลหมอกยามเช้า น้ำตกฝั่งขวา นาขั้นบันไดสีทอง — น่านเป็นจังหวัดที่มีพื้นที่ป่ามากที่สุดในภาคเหนือ",
  ...
  },
  {
    ...
    desc: "วัดภูมินทร์ประดับภาพจิตรกรรมฝาผนังอันงดงาม ชุมชนไทลื้อบ้านหนองบัว ผ้าทอลายโบราณที่ยังสืบทอดจนวันนี้",
  ...
  },
  {
    ...
    desc: "บ่อเกลือสินธุ์โบราณอายุนับพันปี นาเกลือที่หาชมไม่ได้จากที่ไหนในไทย วิถีเกษตรกรรมและชุมชนที่ยังคงสมบูรณ์",
    ...
    <section style={{ padding: "5rem 1.5rem", background: "var(--nan-cream)" }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "3.5rem" }}>
          ...
          >
            จังหวัดที่ยังคงรักษาความดั้งเดิมไว้ได้มากที่สุดแห่งหนึ่งของประเทศไทย
          </p>
        </div>
